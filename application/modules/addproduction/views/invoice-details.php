              ...
              <tbody>
                <tr>
                  <td colspan="2" class="blank" align="center">
                    <img src="<?=base_url();?>assets/inv_css/images/2805747.png" alt="">
                  </td>
                  <td colspan="14" align="center" class="blank">
                    ...
                    <h3>Plot No.3, Thakur Complex, Mujessar (Opp. Escort Crane Shart Div.) <br />
                      Sector-24, Faridabad GSTIN No. 06ARFPS0542R1ZB
                    </h3>
                  </td>
                </tr>
                <tr>
                ...
                <tr class="tr-t">
                  <td colspan="12" rowspan="3" class="td-r">
                    <h2>INVOICE</h2>
                  </td>
                ...
                <tr>
                  <td colspan="9" rowspan="4" class="td-r tr-b">
                    <p>Total Gst Amount in Words: </p>
                    <p><?php echo  words_repues(number_format((float)$inviceres->total_gst_tax_amt, 2, '.', '')); ?></p>
                    <p>Total Invoice In Worrds:<?php echo  words_repues(number_format((float)$inviceres->grand_total, 2, '.', '')); ?></p>
                  </td>
