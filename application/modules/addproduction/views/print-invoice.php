...
if($id!="")
{
$invice12=$this->db->query("select * from tbl_quotation_purchase_order_hdr where purchaseid='$id'");
...
<img src="<?=base_url();?>assets/images/logo.png" style="height:90px;" alt=""></td>
<td colspan="16" align="center" class="blank">
<h1>Dapper Exports Private Limited</h1> 
<h2>Manufacturers, Traders and Exporters. </h2> 
<h3>Head Office-Flat No. 1, 101, Local Shopping Centre Ram Pratap House, Guru Ravidas Marg, Block K, Kalkaji, New Delhi, Delhi 110019.</h3></td>
</tr>
<tr class="tr-t">
<td colspan="12" class="td-r"><h2>Purchase Order</h2></td>
<td colspan="6"><strong>&nbsp;</strong></td>
</tr>
<tr class="tr-t">
    <td colspan="3"><strong>PO. Number :</strong></td>
  <td colspan="4"><?=$inviceres->purchaseid;?></td>
  <td>&nbsp;</td>
...
extract($_POST);
$n=1;
$inviceQ=$this->db->query("select * from tbl_quotation_purchase_order_dtl where purchaseid='$id'");
...
<?php
$total= "";$taxableVal="";$listPrice="";
if($invoiceFetch->net_price != "")
$listPrice=$listPrice+number_format($invoiceFetch->net_price,2, '.', '');

if($invoiceFetch->list_price*$invoiceFetch->qty != "")
...
<td><h5 style="text-align:right;"><strong>E-mail: office@dapperexports.com</strong></h5></td>
</tr>
</table>
</div>
