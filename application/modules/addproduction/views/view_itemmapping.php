    ...
    <div class="accordion" id="accordion2">
      ...
      <div class="panel accordion-group">
        <div class="accordion-heading">
          <h6 class="title"><a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#collapse<?=$i;?>" aria-expanded="false"><?=$dt['item'];?> <span class="pull-right"style="color:red;font-size:12px"><?php if($dt['part'] == ""){ ?><?php $productionQty=$dt['productionQty']?> <?php } ?></span></a> </h6>
        </div>
        <div id="collapse<?=$i;?>" class="accordion-body collapse" aria-expanded="false" style="height: 0px;">
          <div class="accordion-inner">
            <table class="table table-condensed">
              ...
              <tbody>
                <?php   //if($dt['part'] != ""){
                  $mQuery=$this->db->query("select *from tbl_machine where machine_name ='".$dt['itemid']."'");
                ...
                <tr>
                  ...
                  <td><?=$rt->Netqty;?> ( <?=$getUsagesUnit->keyvalue;?> )</td>
                  <td><?=$rt->Castqty;?> ( <?=$getUsagesUnit->keyvalue;?> )</td>
                  <td><?=$productionQty;?></td>
                  <td>(<?=$rt->Netqty*$productionQty;?>)(<?=$rt->Castqty*$productionQty;?>)</td>
