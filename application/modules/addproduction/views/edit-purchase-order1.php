<?php
  $this->load->view("header.php");
   ...
   $id=$_GET['id'] != ""?$_GET['id']:$_GET['view'];
  
   $query  = $this->db->query("select * from tbl_quotation_purchase_order_hdr where purchaseid=$id");	
   $fetchq = $query->row();
            ...
            <table class="table table-striped table-bordered table-hover" <?php if($_GET['view']!=''){?> oncontextmenu='return false;' onkeydown='return false;' onmousedown='return false;' <?php }?> >
              <thead>
                <tr>
                  ...
                  <th><input type="text" name="purchase_no" class="form-control"  required  value="<?=$fetchq->purchase_no;?>">
                  </th>
                  <th>Vendor Name</th>
                  <th>
                    <div class="field">
                      <select name="vendor_id" required id="contact_id_copy" class="form-control ui fluid search dropdown email" onChange="document.getElementsByName('contactid')[0].value=this.value;">
                        ...
                        <?php
                          ...
                          {
                          ?>
                        <option value="<?=$contRow->contact_id; ?>" <?php if($contRow->contact_id==$fetchq->vendor_id){ ?> selected="selected" <?php }?>>
            ...
            <table class="table table-striped table-bordered table-hover" <?php if($_GET['view']!=''){?> oncontextmenu='return false;' onkeydown='return false;' onmousedown='return false;' <?php }?> >
              <tbody>
                ...
                <tr class="gradeA">
                  <th style="width:280px;">
                    <div class="input-group">
                      <div style="width:100%; height:28px;" >
                        <input type="text" name="prd"  onkeyup="getdata()" onClick="getdata()" class="form-control" id="prd" style=" width:230px;"  placeholder=" Search Items..." >
                        ...
                        <img style="display:none" src="<?php echo base_url();?>/assets/images/search11.png"  onclick="showall()" onMouseOver="showall1()" />
                      </div>
                    </div>
                  ...
                  <th style="display:none"><input type="text" name="saleamnt" readonly="" id="tot" class="form-control"  style="width:70px;"/ ></th>
              ...
              <table id="invoice"  style="width:100%;background:white;margin-bottom:0px;margin-top:0px;min-height:30px;" title="Invoice" class="table table-bordered blockContainer lineItemTable ui-sortable"  >
                ...
                <tr>
                  ...
                  <td align="center" style="width: 3%;display:none">
                    <input type="text" name="list_price[]" id="lph<?php echo $z;?>" value="" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  ...
                  <td align="center" style="width: 3%;display:none"><input type="text" name="discount[]" id="dis<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none"><input type="text" name="disAmount[]" id="disAmount<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none"><input type="text" name="cgst[]" id="cgst<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none"><input type="text" name="sgst[]" id="sgst<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none"><input type="text" name="igst[]" id="igst<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none"><input type="text" name="gstTotal[]" id="gstTotal<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  </td>
                  <td align="center" style="width: 3%;display:none">
                    <input type="text" name="tot[]" id="tot<?php echo $z;?>" value="" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;display:none">
                    <input type="text" name="nettot[]" id="nettot<?php echo $z;?>" value=""readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;">
                    <img src="<?php echo base_url();?>assets/images/delete.png" border="0" name="dlt" id="dlt<?php echo $z;?>" onclick="deleteselectrow(this.id,this);"   style="border: hidden;">
                    <img src="<?php echo base_url();?>assets/images/edit.png" border="0" name="ed" id="ed<?php echo $z;?>" onclick="editselectrow(this.id,this);" style="border: hidden;">
                  </td>
                </tr>
                <?php 
            ...
            <table class="table table-striped table-bordered table-hover" <?php if($_GET['view']!=''){?> oncontextmenu='return false;' onkeydown='return false;' onmousedown='return false;' <?php }?> >
              <tbody>
                <tr class="gradeA">
                  ...
                  <th>&nbsp;</th>
                  <th>
                    <input type="text" placeholder="Total Quantity" value="<?=$qtyvalue;?>" id="qty_total" readonly="" name="qty_total" class="form-control">
                  </th>
                </tr>
                ...
                <tr  class="gradeA" style="display:none">
                  ...
                  <th><input style="display:none;" type="number" name="total_dis" value=""  id="total_dis" step="any" min="0" placeholder="%" class="form-control"></th>
                  <th><input type="number" readonly="" name="total_dis_amt" id="total_dis_amt" step="any" value=""  placeholder="Placeholder" class="form-control"></th>
                </tr>
                <tr class="gradeA" style="display:none">
                  <th>Grand Total</th>
                  <th>&nbsp;</th>
                  <th><input type="number" readonly="" step="any" id="grand_total" value="" name="grand_total" placeholder="Placeholder" class="form-control"></th>
                </tr>
                <tr class="gradeA">
                  <th>
                  <th>&nbsp;</th>
