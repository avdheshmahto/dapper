              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover " >
                  ...
                  <tr class="gradeX odd" role="row">
                    ...
                    <?php
                      $poLogQuery=$this->db->query("select SUM(qty) as po_qty from tbl_purchase_order_dtl where purchaseid='$getHdr->po_no' and productid='$getProduct->productid'");
                    ...
                    <?php
                      ...
                      $inbountLogGRNQuery=$this->db->query("select SUM(receive_qty) as rec_qty from tbl_inbound_log where productid='$getProduct->productid' and po_no='$getHdr->po_no' and inboundrhdr='$id'");
