      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover " >
          ...
          <tr class="gradeX odd" role="row">
            ...
            <td> <input class="form-control" onchange="totalWeightCal(this.id)"  style="margin-bottom:10px;width:100px;" value="" type="number" min="0" step="any" name="total_weight[]" id="total_weight<?=$i;?>" <?php if($reci_qty==0){?> readonly="readonly" <?php }?>  /></td>
