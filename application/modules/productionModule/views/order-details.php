        ...
        <table class="table table-striped table-bordered table-hover " >
          ...
          <tr class="gradeX odd" role="row">
            ...
            <td>
              ...
              <input name="qty[]" id="qty<?=$i;?>" onkeyup="qtyVal(this.id)" type="number" min="0" class="form-control"<?php if($reci_qty==0){?> readonly="readonly" <?php }?> />
              <input type="text" style="display:none" name="process_ends[]" value="1" />
            </td>
            <td> <input class="form-control" onchange="totalWeightCal(this.id)"  style="margin-bottom:10px;width:55px;" value="" type="number" min="0" step="any" name="total_weight[]" id="total_weight<?=$i;?>" <?php if($reci_qty==0){?> readonly="readonly" <?php }?>  /></td>
