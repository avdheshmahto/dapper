				...
				<div class="panel panel-default">
				   <div class="panel-body">
					 <div class="form-group">
					   ...
					   <input type="text" name="invoice_no"  class="form-control" value="<?=$getHdr->po_no;?>" readonly="readonly" required />

					  </div>

<div class="col-sm-6" id="invoiceId" >
					 	<label for="po_order">GRN Date.:</label>
					    <input type="text" name="invoice_no"  class="form-control" value="<?=$getHdr->maker_date;?>" readonly="readonly" required />
	...
	<!-- <div class="table-responsive-">
      ...
      <?php
		$productQuery=$this->db->query("select SUM(receive_qty) as poQty,productid,inboundrhdr from tbl_production_grn_dtl where inboundrhdr='$id' group by productid ");
			$i=1;
       ...
       <tr class="gradeX odd" role="row">
										...
										$inbountLogQuery=$this->db->query("select SUM(receive_qty) as rec_qty from tbl_production_grn_log where productid='$getProduct->productid' and po_no='$getHdr->po_no'");
											$getInbound=$inbountLogQuery->row();
						
						$inbountLogGRNQuery=$this->db->query("select SUM(receive_qty) as rec_qty from tbl_production_grn_log where productid='$getProduct->productid' and po_no='$getHdr->po_no' and inboundrhdr='$id'");
