...
<td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="55%"><?=$getHdr->request_no;?></td>
    <td width="18%"><strong>Date:</strong></td>
    <td width="12%"><?=$getHdr->maker_date;?></td>
  </tr>
...
<?php 
//echo "select *from tbl_receivematrial_dtl where inboundrhdr='$id'";
			$selectQuery=$this->db->query("select *from tbl_issuematrial_dtl where inboundrhdr='$id'");
               $i=1;
