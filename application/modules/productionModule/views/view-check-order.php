            ...
            <div class="force-overflow-y">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover " >
                  ...
                  <?php
                    $productQuery=$this->db->query("select *from tbl_production_order_check where check_no='$id'");
                    	$i=1;
                  ...
                  <tr class="gradeX odd" role="row">
                    ...
                    <?php
                      ...
                      ?>
                    <td class="tdcenter"><?=$getProduct->transfer_qty;?></td>
                    <td class="tdcenter"><?=$getProduct->repair_qty;?></td>
                    <td class="tdcenter"><?=$getProduct->scrap_qty;?></td>
                    <td class="tdcenter"><?=$getProduct->test_qty;?></td>
                    <td class="tdcenter"><?=$getProduct->name;?></td>
                  </tr>
                  <?php 
                    $i++;
                    }?>
