...
$orderQuery=$this->db->query("select *from tbl_production_order_repair where job_order_id='$id'");
				...
				<div class="panel panel-default">
				   <div class="panel-body">
					 <div class="form-group">
                       ...
                       <input type="hidden" name="grn_type" value="Repair_order_grn" />
                       ...
                       <input type="hidden" name="vendor_id" value="<?=$getOrder->vendor_id;?>" />
                        ...
                        <input type="hidden" name="req_production_id" value="<?=$po_no;?>" />
					      <input type="text" name="order_no"  class="form-control" value="<?=$getOrder->order_no;?>" readonly="readonly" required />

					  </div>

<div class="col-sm-6" id="invoiceId" >
					 	<label for="po_order">Order Date.:</label>
					    <input type="text" name="invoice_no"  class="form-control" value="<?=$getOrder->maker_date;?>" readonly="readonly" required />
...
<div class="col-sm-6" id="invoiceId" >
	...
	<!-- <div class="table-responsive-">
      ...
      <?php
		$productQuery=$this->db->query("select *from tbl_production_order_repair where job_order_id='$id'");
		$i=1;
...
//echo "select SUM(qty) as rec_qty from tbl_production_order_log where productid='$getProduct->productid' AND job_order_id = '$lot_no' and order_no='$id' and grn_type='Repair_order_grn'";
$inbountLogGRNLogQuery=$this->db->query("select SUM(qty) as rec_qty from tbl_production_order_log where productid='$getProduct->productid' AND job_order_id = '$lot_no' and order_no='$id' and grn_type='Repair_order_grn'");
            ...
            <td><?php echo $reci_qty=$getProduct->qty-$getInboundGRNLog->rec_qty;?></td> <input type="text" style="display:none" name="process_ends[]" value="1" />
