...
<div class="main-content">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover " >
                  ...
                  <tr class="gradeX odd" role="row">
                    ...
                    <td class="tdcenter"><?=$getProductStock->productname;?>
                    ...
                    <td class="tdcenter"><?=$getProduct->receive_qty;?></td>
                  </tr>
                  <?php 
                    $i++;
                    }?>
 ...
 <div class ="pull-right" id="saveDiv">&nbsp;<a  class="btn btn-sm" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">Cancel</span></a>
</div>
</div>      