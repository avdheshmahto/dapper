              ...
              <tbody>
                ...
                <tr class="gradeA" data-row-id="<?php echo $getProduction->purchaseorderid; ?>">
                  ...
                  <th style="width:180px;">
                    ...
                    <input type="text" name="test_param[]" value="<?=$getDeliveryPeriod->test_param;?>"      tabindex="5" class="form-control" >
                  </th>
                  <th style="width:200px;" >
                    <input type="text" name="specification[]" value="<?=$getDeliveryPeriod->specification;?>"  class="form-control">
                  </th>
                  <th style="width:200px;" >
                    <input type="text" name="specification2[]" value="<?=$getDeliveryPeriod->specification2;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp1[]" value="<?=$getProduction->insp1;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp2[]" value="<?=$getProduction->insp2;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp3[]" value="<?=$getProduction->insp3;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp4[]" value="<?=$getProduction->insp4;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp5[]" value="<?=$getProduction->insp5;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp6[]" value="<?=$getProduction->insp6;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp7[]" value="<?=$getProduction->insp7;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp8[]" value="<?=$getProduction->insp8;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp9[]" value="<?=$getProduction->insp9;?>"  class="form-control">
                  </th>
                  <th >
                    <input type="text" name="insp10[]" value="<?=$getProduction->insp10;?>"  class="form-control">
                  </th>
                </tr>
                <?php $i++; }?>
              </tbody>
