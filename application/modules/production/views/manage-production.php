...
<ol class="breadcrumb breadcrumb-2"> 
	...
	if($add!='')
	{ ?>
	<li><a class="btn btn-sm" href="<?=base_url();?>production/add_production"><i class="fa fa-plus"></i>Add Production</a></li> 
	<?php }?>
	</div>
</ol>
...
<tr>
	...
	<th>Filled Qty</th>
	<th>Remaining Qty</th>
   	<th>Status Of Overlocking</th>
    <th><div style="width: 210px;">Action</div></th>
</tr>
</thead>
...
foreach($result as $sales)
  {
$sum=0;
$queryfetch11=$this->db->query("select * from tbl_overlock where production_id='$sales->productionid'");	
...
//echo $obj->getManagePageData($table_name,$pri_id,$id,$field_name);?>
</th>
<th><?=$sales->qty;?></th>
<?php 
	if($sum !='') {
?>
<th><?php echo $sum; } else { ?> </th>
<th>0</th>
<?php } ?>
...
?></th>
<th>
<button class="btn btn-sm modalProduction" data-a="<?php echo $sales->productionid;?>" href='#editProduction' onclick="addOverlock('<?php echo $sales->productionid;?>')" type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'>OverLocking</button>
...
<?php }else{ ?>
	<button class="btn btn-default" id="<?php echo $sales->productionid."^".$table_name."^".$pri_col ; ?>" onclick="return confirm('This Product is already Assign in Cutting . You Can not deleted.');" type="button"><i class="icon-trash"></i></button>
<?php }?>
