...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body >
    ...
    <form method="post">
      ...
      <!--<input type="submit" name="update" value="print" onClick="window.print()" class="no-print submit">-->
      <h1 style="text-align:center;"><?php echo tax($inviceres->tax_retail);?> </h1>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2" style="border:none;">
                  ...
                  <p align="center">(ISSUE OF INVOICE UNDER RULE 11 OF CENTRAL EXCISE RULES 2002)</p>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="50%" style="border:none;">
                  <select style="border:hidden" name="dropDown">
      ...
      <table width="100%" id="items" style="">
        ...
        <tr>
          <td style= "border: none;border-left:1px solid black; text-align:center"><?php echo $n;?>
            <input type="checkbox"  checked="checked" name="invoice_dtl_id1[]" id='quantity<?php echo $j?>' value="<?php echo $invoice_dtl_id;?>" readonly onblur='testRate<?php echo $i?>();' style="width:4em;border:none;display:none" />
          </td>
        ...
        <tr>
          ...
          <td class="total-line" colspan="2"><strong><?php echo @number_format($inviceres->service_charge_percentage,2, '.', ''); ?></strong><br/>
            <?php echo $inviceres->service_charge ;?>
          </td>
        </tr>
        <tr>
        ...
        <tr style="display:none";>
          <td colspan="6" rowspan="2">
            <span style="font-weight:bold" >Tax(<i class="fa fa-inr" style="font-size:12px"></i>):&nbsp;</span><?php 
