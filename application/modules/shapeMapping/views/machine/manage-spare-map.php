              ...
              <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #F5F5F5; color:#000000; border-color:#DDDDDD;">
                  <h3 class="panel-title" style="float: initial;"><?=$getMachine2->productname."(".$getMachine2->sku_no.")";?>
                    <a href="<?=base_url('shapeMapping/manage_shape');?>" class="btn  btn-sm pull-right" type="button"><i class="icon-left-bold"></i> back</a>
                  </h3>
                </div>
                <br><br>
                <div class="panel-body" >
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example1" >
                      ...
                      <tbody>
                        <tr class="gradeX">
                          ...
                          <td>
                            <!-- <button class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal-2" type="button" data-backdrop="static" data-keyboard="false" title=" View Contact Mapping" onclick="mappingQtybyproduct(<?=$getMachine1->Product_id;?>,<?=$_GET['id'];?>,'shape');"><i class="icon-flow-tree"></i></button> -->
