...
<table id="items">
<tr>
<th colspan="4"><center>Order Check Challan</center></th>
</tr>
<tr class="item-row">
...
<?php 
$selectQuery=$this->db->query("select *from tbl_production_order_check where check_no='$id'");
$i=1;
