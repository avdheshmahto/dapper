<?php
$hdrQuery=$this->db->query("select *from tbl_production_order_log where grn_no='$id'");
$getHdr=$hdrQuery->row();
...
<table id="items">
<tr>
<th colspan="4"><center>Order Grn Challan</center></th>
</tr>
<tr class="item-row">
...
<?php 
$selectQuery=$this->db->query("select *from tbl_production_order_log where grn_no='$id'");
$i=1;
