...
<table id="items">
<tr>
<th colspan="4"><center>Order Transfer Challan</center></th>
</tr>
<tr class="item-row">
...
<?php 
$selectQuery=$this->db->query("select *from tbl_production_order_transfer_another_module where transfer_no='$id'");
$i=1;
