    ...
    <div class="force-overflow-y">
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover " >
          ...
          <?php
            $productQuery=$this->db->query("select SUM(transfer_qty) as qty ,productid from tbl_production_available_order where lot_no='$id' and order_type='Kora Order' group by productid" );
            $i=1;
