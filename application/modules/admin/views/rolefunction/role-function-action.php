...
<h4 class="panel-title heading" style="margin: 0px 0px 0px -15px;"><strong>Add Role Function Action</strong></h4>
<br />
<br />
...
<div class="panel-body">
<div class="form-group">
<label class="col-sm-4 control-label"><strong style="font-size:14px;margin: 0px 0px 0px -30px;">Module Name</strong></label>
