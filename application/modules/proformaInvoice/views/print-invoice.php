    ...
    <div id="page-wrap">
        ...
        <tbody>
          <tr>
            <td colspan="2" class="blank" align="center">
              <img src="<?=base_url();?>assets/inv_css/images/2805747.png" style="height:90px;" alt="">
            </td>
      ...
      <table width="90%" style="margin:auto;" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
            <h5 style="text-align:right;"><strong>E-mail: glitz03@rediffmail.com</strong></h5>
          </td>
        </tr>
      </table>
    </div>
