...
<ol class="breadcrumb breadcrumb-2"> 
	...
	<li class="active"><strong>Manage Inspection</strong></li> 
...
<a href="<?=base_url();?>dispatch/manage_dispatch_map?id=<?=$sales->lot_no;?>"><img src="<?=base_url();?>assets/images/click.png" height="25" width="50" /></a>
