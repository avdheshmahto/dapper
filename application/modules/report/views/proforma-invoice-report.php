  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h4 class="panel-title">PROFORMA INVOICE REPORT </h4>
      ...
      <div class="panel-body" style="    background: #dedede;    padding: 20px 0px;    margin-bottom: 25px;">
        <form class="form-horizontal" method="get">
          <div class="form-group panel-body-to">
            ...
            <div class="col-sm-3">
              <select name="cstmr_name"  class="form-control">
        ...
        <div class="col-sm-12">
          <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            ...
            <div class="dataTables_length" id="DataTables_Table_0_length">
              <label>
                &nbsp;&nbsp; Show
                <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('/report/Report/searchProInvoice');?>" class="form-control input-sm">
          ...
          <table class="table table-striped table-bordered table-hover dataTables-example1" id="tblData" >
            ...
            <tbody id="getDataTable">
              ...
              <tr class="gradeC record">
                ...
                <th>
                  <button class="btn btn-default" onClick="openpopup('<?=base_url();?>report/Report/view_proforma_invoice',1400,600,'view',<?=$sales->invoiceid;?>)" type="button" data-toggle="modal" data-target="#modal-<?php echo $i; ?>"> <i class="fa fa-eye"></i> </button>
                </th>
              </tr>
              <?php } //} ?>
            </tbody>
...
<script>
  function exportTableToExcel(tableID, filename = ''){
    ...
    //alert();
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProformaInvoiceReport_<?php echo date('d-m-Y');?>.xls';
