  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h4 class="panel-title">PRODUCTION CUTTING REPORT</h4>
      ...
      <div class="panel-body" style="padding: 20px 0px;    margin-bottom: 25px;">
          ...
          <table class="table table-striped table-bordered table-hover dataTables-example" >
            ...
            <tbody>
              ...
              <tr class="gradeC record">
                ...
                <th><?=$rows['log_qty']!=""?$rows['log_qty']:'0';?></th>
                <th><?php echo $rows['raphu'];?></th>
                <th><?php echo $rows['log_qty']+$rows['raphu'];?></th>
