            ...
            <table class="table table-striped table-bordered table-hover" <?php if($_GET['view']!=''){?> oncontextmenu='return false;' onkeydown='return false;' onmousedown='return false;' <?php }?> >
              <thead>
                <tr>
                  ...
                  <th>
                    <div class="field">
                      <select class="form-control" name="state_id" id="state" onchange="getVendor();">
                ...
                <tr>
                  <td>WFF Date</td>
                  <th>
                    <input type="date"  class="form-control" required name="wff_date" value="<?php echo $fetchq->wff_date;?>" />
                  </th>
                  <td>Valid Till Date</td>
                  <th>
                    <input type="date"  class="form-control" required name="valid_till_date" value="<?php echo $fetchq->valid_till_date;?>" />
                  </th>
                  <td>Reference</td>
                  <th>
                    <input type="text"  class="form-control" required name="reference" value="<?php echo $fetchq->reference;?>" />
                  </th>
                  <td>Place of Supply</td>
                  <th>
                    <input type="text"  class="form-control" required name="Place_of_Supply" value="<?php echo $fetchq->invoice_date;?>" />
                  </th>
                </tr>
                <tr>
                  <td>Freight</td>
                  <th>
                    <input type="text"  class="form-control" required name="freight" value="<?php echo $fetchq->freight;?>" />
                  </th>
