<table class="table table-striped table-bordered table-hover dataTables-example1">
  ...
  <tbody>
    ...
    <tr class="gradeU record">
      <td> <input class="form-control" style="margin-bottom:10px; border:none; width:100%;" value="<?=$getProduct->sku_no;?>" name="part[]" readonly>
      ...
      <td> <input class="form-control" style="margin-bottom:10px;width:100%;" value="" name="qty[]" id="entQty<?=$i;?>" onkeyup="val(this.id)" readonly="readonly" /></td>
    </tr>
    <?php $i++;}?>
  </tbody>
  <tfoot>
