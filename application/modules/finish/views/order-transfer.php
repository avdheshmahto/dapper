      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover " >
          ...
          <tr class="gradeX odd" role="row">
            ...
            <?php
              $inbountLogGRNLogQuery=$this->db->query("select SUM(qty) as rec_qty from tbl_production_order_transfer_another_module where productid='$getProduct->productid' AND  order_no='$id' and module_name='Assemble'");
