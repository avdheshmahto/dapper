<?php
$queryData=$this->db->query("select *from tbl_production_order_check where lot_no='$id' and test_qty!=''");
$getData=$queryData->row();
?>
<form class="form-horizontal" role="form"  enctype="multipart/form-data"   id ="myProduction_purchase" action="#" onsubmit="return submitProductionPurchase();"method="POST"> 
<div class="modal-body">
<div class="form-group">
<label class="col-sm-2 control-label">Lot No.:</label> 
<div class="col-sm-4">
<input name="date" type="text" value="<?=$id;?>" class="form-control" id="thickness" readonly> </div>
