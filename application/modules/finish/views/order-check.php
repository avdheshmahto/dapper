...
<?php
	$productQuery=$this->db->query("select SUM(qty) as qty,productid from 	tbl_production_order_log where order_no='$id' and grn_type='Finish Order' and process_ends='1' group by productid");
		$i=1;
