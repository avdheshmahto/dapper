...
<div class="" id="style-3-y">
      ...
      <?php
		$productQuery=$this->db->query("select SUM(qty) as qty,productid from tbl_production_order_transfer_another_module where lot_no='$id' and module_name='Finish' group by productid");
			$i=1;
