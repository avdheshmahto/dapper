<?php
  ...
  $queryData=$this->db->query("select *from tbl_production_order_transfer_another_module where transfer_no='$id'");
        ...
        <div class="panel-body">
          <div class="form-group">
            <div class="col-sm-6">
              ...
              <input type="text" name="transfer_no"  class="form-control" value="<?=$getData->transfer_no;?>" readonly="readonly" required />
            </div>
            <div class="col-sm-6" id="invoiceId" >
              <label for="po_order">Transfer Date.:</label>
              <input type="text" name="transfer_date"  class="form-control" value="<?=$getData->transfer_date;?>" readonly="readonly" required />
            </div>
    ...
    <div class="force-overflow-y">
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover " >
          ...
          <?php
            $productQuery=$this->db->query("select *from tbl_production_order_transfer_another_module where lot_no='$id'");
            $i=1;
