				  ...
				  $getUsagesUnit=$usagesUnitQuery->row();
                             ?>
                                <tr>
                                  ...
                                  <td>
                                  <?php
								  $partQuery=$this->db->query("select SUM(transfer_qty) as qty from tbl_production_order_check where lot_no='$lot_no' and transfer_qty!='' and productid='$rt->part_id'");
