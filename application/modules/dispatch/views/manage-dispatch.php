...
<div class="modal-header">
       ...
       <table class="table table-bordered table-hover" >
            ...
            ?>
              	<tr>
                <td><select name="lot" class="form-control">
                <option value="">--Select--</option>
				<?php
                ...
                <?php }?>
              	...
              	<td><input type ="hidden" name="prodcId[]" value="<?=$getProduct->Product_id;?>">
...
<ol class="breadcrumb breadcrumb-2"> 
 ...
 <li>   <button type="button" class="btn btn-default modalMapSpare" data-toggle="modal" data-target="#modal-2">ADD Dispatch</button> </li>
