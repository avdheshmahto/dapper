...
function submitProductionOrderCheck() {
  ...
  $.ajax({
      url: "<?=base_url();?>inspection/productionOrderCheck",
      type: "POST",
      data: form_data,
      processData: false,  // tell jQuery not to process the data
      contentType: false   // tell jQuery not to set contentType
...
<h3 class="panel-title" style="float: initial;"><span style="color:#000;">Oder Details:-</span><?=$getsched->inboundid;?>
	...
	<a href="<?=base_url();?>inspection/manage_inspection_map?id=<?=$getsched->production_id;?>" class="btn  btn-sm pull-right" type="button"><i class="icon-left-bold"></i> back</a>
</h3>
</div>
...
<li style="display:none;" ><a href="#home" data-toggle="tab" class="active">GRN</a></li>

<li ><a href="#check" class="active" data-toggle="tab">Checking</a></li>
