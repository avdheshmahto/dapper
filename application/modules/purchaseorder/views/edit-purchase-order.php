    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <h4 class="panel-title"><strong><?php if($_GET['id']!=''){?>Update <?php } else {?> View <?php }?> RM Planning</strong></h4>
                  ...
                  <th style="display:none;">
                    <div class="field">
                      <select name="invoice_type" class="form-control"   id="invoice_type"   <?php if(@$_GET['view']!=''){ ?> disabled="disabled" <?php }?>>
                        ...
                        <option value="No-Tax"  selected="selected">
                          No-Tax
                        </option>
                      </select>
                    </div>
          ...
          <div style="width:100%; background:#dddddd; padding-left:0px; color:#000000; border:2px solid ">
            <table id="invo" style="width:100%;  background:#dddddd;  height:70%;" title="Invoice"  >
              <tr>
                ...
                <td style="width:3%;">
                  <div align="center"><u>Usage Unit</u></div>
                </td>
                <td style="width:3%;">
            ...
            <div style="width:100%; background:white;   color:#000000;  max-height:170px; overflow-x:auto;overflow-y:auto;" id="m">
              <table id="invoice"  style="width:100%;background:white;margin-bottom:0px;margin-top:0px;min-height:30px;" title="Invoice" class="table table-bordered blockContainer lineItemTable ui-sortable"  >
                ...
                <tr>
                  ...
                  <?php
                    //echo "select *from tbl_master_data where serial_number='$getProductName->usageunit'";
                    $selectTypeQuery=$this->db->query("select *from tbl_master_data where serial_number='$getProductName->usageunit'");
                    $getType=$selectTypeQuery->row();
                    ?>
                  <input type="hidden" name="typee[]" id="lph<?php echo $z;?>" value="<?php echo $getType->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  <input type="hidden" name="type[]" id="type<?php echo $z;?>" value="<?php echo $invoiceFetch->type;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  <td align="center" style="width: 3%;">
                    <input type="text" name="qn_pc[]" id="qn_pc<?php echo $z;?>" value="<?php echo $invoiceFetch->qn_pc;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;">
                    <input type="text" name="qn_pcioo[]" id="qn_pcooo<?php echo $z;?>" value="<?php echo $getType->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
                  <td align="center" style="width: 3%;">
                    <input type="text" name="circle_weight[]" id="or_qn<?php echo $z;?>" value="<?php echo $invoiceFetch->circle_weight;?>" readonly="" style="text-align: center; width: 100%; border: hidden;">
                  </td>
