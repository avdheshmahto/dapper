...
<td style="width:3%;"><div align="center"><u>Usage Unit</u></div></td>
<td style="width:3%;"><div align="center"><u>Circle Weight </u></div></td>
<td style="width:3%;"><div align="center"><u>Total Weight </u></div></td>

<td style="width:3%;"> <div align="center"><u>Rate</u></div></td>

<td style="width:3%;"> <div align="center"><u>Dis.%</u></div></td>
<td style="width:3%; display:none1;"> <div align="center"><u>Discount Amt</u></div></td>
...
<input type="text" name="qn_pc[]" id="qn_pc<?php echo $z;?>" value="<?php echo $invoiceFetch->qn_pc;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
<td align="center" style="width: 3%;">
<input type="text" name="qn_pcioo[]" id="qn_pcooo<?php echo $z;?>" value="<?php echo $getType->keyvalue;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>

<td align="center" style="width: 3%;">
<input type="text" name="circle_weight[]" id="or_qn<?php echo $z;?>" value="<?php echo $invoiceFetch->circle_weight;?>" readonly="" style="text-align: center; width: 100%; border: hidden;"></td>
