...
<th>
<input type="text" step="any" id="or_qn" min="1" style="width:70px;"   class="form-control"></th>


<th>
<input type="number" id="qn" min="1" style="width:90px;"   class="form-control"></th>
...
<td style="width:11%;"><div align="center"><u>RM Code</u></div></td>
