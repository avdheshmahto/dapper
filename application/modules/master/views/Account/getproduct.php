...
<?php
  //echo "select * from tbl_product_stock where productname like '%$con3%' AND supplier_id = $suppliercontact AND  location = $company";
  if($con1!="")
  {
     $qryy =  "select * from tbl_product_stock where productname like '%$con3%'";
