      ...
      <table class="table table-striped table-bordered table-hover dataTables-example1" id="tblData" >
        <thead>
          <tr>
            ...
            <th>
              <div style="width:100px;">Main Unit</div>
            </th>
            <th>
              <div style="width:100px;">Sub Unit</div>
            </th>
            <th>
              <div style="width:100px;">Conversion Factor</div>
            </th>
            <th>
        ...
        <tbody id="getDataTable" >
          ...
          <tr  class="gradeC record" data-row-id="<?php echo $fetch_list->Product_id; ?>">
            ...
            <?php
              ...
              ?>
            <th><?=$fetch_list->unit_name;?></th>
            <th><?=$fetch_list->unit_conversion_name;?></th>
