      ...
      <table class="bordered">
        ...
        <tr>
          ...
          <td><input type="hidden" name="mid" value="<?php if(@$_GET['mid']==''){ echo $mid=1;}else{echo $midd=@$_GET['mid'];}?>">
            <input name="account_name" required type="text" onchange="accountFun1(this.value)" class="span6" id="account_name"  size="22"  aria-required='true' value="<?php if(@$_GET['mid']=='' && @$_GET['id']!=''){ echo $branchFetch->account_name; }?>"/><a id="accountdiv" style="color:#0000FF"></a>
          </td>
