...
function tree_all()
{
 ...
 function insert_value($post){
    ...
    return $this->db->query($sql,array($post['typee'],$post['category'],$post['selectCategory'],$data));
...
function treeGetParentValue($id = 0, $user_tree_array = ''){
 ...
 function edit_Category($post){
    ...
    $this->db->query($qry,array($post['typee'],$post['category'],$post['selectCategory'],$post['edit']));
}
